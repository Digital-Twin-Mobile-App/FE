    ...
    <SafeAreaView className="flex-1">
      <LinearGradient colors={["#A8E6CF", "#56AB2F"]} className="flex-1 px-6 pt-8">
        ...
        <View className="bg-white rounded-2xl p-8 w-full max-w-md shadow-lg mt-22">
          ...
          <TextInput placeholder="Enter your email" keyboardType="email-address" className="border border-gray-300 rounded-full px-4 py-3 mb-6" value={email} onChangeText={setEmail} />
